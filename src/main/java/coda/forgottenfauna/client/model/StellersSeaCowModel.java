...
public class StellersSeaCowModel<T extends Entity> extends AgeableModel<StellersSeaCowEntity> {
    ...
    public StellersSeaCowModel() {
        ...
        this.neck.setPos(0.0F, -3.2F, -22.0F);
        ...
        this.snoutLeft.setPos(2.5F, -1.0F, -12.0F);
        ...
        this.pectoralRight.setPos(-13.0F, 10.0F, -17.5F);
        ...
        this.snoutRight.setPos(-2.5F, -1.0F, -12.0F);
        ...
        this.flukeRight.setPos(-7.0F, 0.0F, 32.0F);
        ...
        this.pectoralLeft.setPos(13.0F, 9.0F, -16.0F);
    ...
    @Override
    public void setupAnim(StellersSeaCowEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        float speed = 1.0f;
        float degree = 1.0f;
        this.body.xRot = MathHelper.cos(limbSwing * speed * 0.2F) * degree * 0.2F * limbSwingAmount;
        this.body.y = MathHelper.cos(-1.0F + limbSwing * speed * 0.2F) * degree * 0.15F * limbSwingAmount + 8.0F;
        this.neck.xRot = MathHelper.cos(2.0F + limbSwing * speed * 0.2F) * degree * 0.15F * limbSwingAmount;
        this.pectoralLeft.xRot = MathHelper.cos(limbSwing * speed * 0.2F) * degree * 0.4F * limbSwingAmount + 1.0F;
        this.pectoralRight.xRot = MathHelper.cos(limbSwing * speed * 0.2F) * degree * 0.4F * limbSwingAmount + 1.0F;
        this.pectoralLeft.yRot = MathHelper.cos(-1.0F + limbSwing * speed * 0.2F) * degree * 0.3F * limbSwingAmount + 0.5F;
        this.pectoralRight.yRot = MathHelper.cos(-1.0F + limbSwing * speed * 0.2F) * degree * -0.3F * limbSwingAmount - 0.5F;
        this.head.xRot = MathHelper.cos(2.0F + limbSwing * speed * 0.2F) * degree * 0.3F * limbSwingAmount;
        this.tail1.xRot = MathHelper.cos(-1.0F + limbSwing * speed * 0.2F) * degree * 0.3F * limbSwingAmount - 0.1F;
        this.tail2.xRot = MathHelper.cos(-2.0F + limbSwing * speed * 0.2F) * degree * 0.35F * limbSwingAmount - 0.05F;
        this.flukeLeft.xRot = MathHelper.cos(-2.0F + limbSwing * speed * 0.2F) * degree * 0.5F * limbSwingAmount;
        this.flukeRight.xRot = MathHelper.cos(-2.0F + limbSwing * speed * 0.2F) * degree * 0.5F * limbSwingAmount;
    }
